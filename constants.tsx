...
export const GENRES = [
  "Lo-Fi", "Synthwave", "Heavy Metal", "Deep House", "Acoustic Pop", 
  "Cyberpunk", "Jazz Fusion", "Classical", "Trap", "Indie Rock", 
  "Reggae", "Country", "Afreobeats", "K-Pop", "Ambient"
];

export const MOODS = [
  "Happy", "Melancholic", "Energetic", "Chill", "Aggressive", 
  "Ethereal", "Cinematic", "Nostalgic", "Dark", "Upbeat", 
  "Relaxing", "Mysterious", "Romantic", "Epic"
];

export const VOCAL_OPTIONS = [
  "Male", "Female", "Duet", "Instrumental", "Auto-Tune", "Gospel Choir", "Spoken Word"
];
